...
let pontos = 0;
let estagio = 1;
let velocidadeBaloes = 1.2; // Velocidade reduzida (antes era 2)
let jogoAtivo = true;
...
function iniciarCorrida(){
    ...
    pontos = 0;
    estagio = 1;
    velocidadeBaloes = 1.2; // Velocidade inicial reduzida
    jogador.vidas = 3;
    jogador.velocidade = 6; // Velocidade do jogador também ajustada para maior controle
    jogoAtivo = true;
    ...
    baloes.forEach(b => {
        ...
        if(detectarColisao(jogador,b)){
            ...
            if(b.correta){
                ...
                if(pontos % 5 === 0){
                    estagio++;
                    velocidadeBaloes += 0.5; // Aumento de velocidade por estágio mais suave (antes era +1)
                }
